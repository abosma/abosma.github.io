...
function getSummonerID() {
    ...
    if (SUMMONER_NAME !== "") {
        $.ajax({
            url: 'https://eune.api.pvp.net/api/lol/eune/v1.4/summoner/by-name/' + SUMMONER_NAME + '?api_key=3aab1f3c-ddc0-4bf8-91d8-ec12113790c5',
            type: 'GET',
            dataType: 'json',
            data: {
...
function getSummonerStats(summonerID, currentPlayer) {
    $.ajax({
        url: 'https://eune.api.pvp.net/api/lol/eune/v1.3/stats/by-summoner/' + summonerID + '/summary?season=SEASON2016&api_key=3aab1f3c-ddc0-4bf8-91d8-ec12113790c5',
        type: 'GET',
        dataType: 'json',
        data: {
