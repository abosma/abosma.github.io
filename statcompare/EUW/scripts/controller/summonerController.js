...
function getSummonerID() {
    ...
    if (SUMMONER_NAME !== "") {
        $.ajax({
            url: 'https://euw.api.pvp.net/api/lol/euw/v1.4/summoner/by-name/' + SUMMONER_NAME + '?api_key=bacda479-8776-49a8-a67b-41579494c93c',
            type: 'GET',
            dataType: 'json',
            data: {
...
function getSummonerStats(summonerID, currentPlayer) {
    $.ajax({
        url: 'https://euw.api.pvp.net/api/lol/euw/v1.3/stats/by-summoner/' + summonerID + '/summary?season=SEASON2016&api_key=bacda479-8776-49a8-a67b-41579494c93c',
        type: 'GET',
        dataType: 'json',
        data: {
