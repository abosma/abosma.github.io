...
document.getElementById("dog").style.content= "url(pics/lesserdog.png)"
...
if(window.screen.availWidth < 1440){
document.getElementById("dog").style.position="absolute";
document.getElementById("dog").style.left="37.6%"
document.getElementById("dog").style.width="162px"
document.getElementById("dog").style.height="309px"
document.getElementById("dog").style.top="3.5%"
document.getElementById("dog").style.zIndex="2"
document.getElementById("dog").style.content= "url(pics/lesserdog.png)"
